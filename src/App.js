  ...
  return (
   ...
   {/* Caroussel */}
    <Carousel>
     ...
     <Card style={{ width: '18rem' }}>
      ...
      <Card.Body className='cb'>  
        <Card.Title>Club Enfant</Card.Title>
        <Card.Text>
        ...
        <Button className='info' variant="primary">S'inscrire</Button>
      </Card.Body>
    </Card>
    ...
    <Card style={{ width: '18rem' }}>
      ...
      <Card.Body className='cb'>
        <Card.Title>Club peinture à huile</Card.Title>
        <Card.Text>
    ...
    <Card style={{ width: '18rem' }}>
      ...
      <Card.Body className='cb'>
        <Card.Title>Club Dessin</Card.Title>
        <Card.Text>
    ...
    <Form>
      ...
      <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
        <Form.Label className='flabelctact'>On vous répondrai dans les plus brefs délais!</Form.Label>
    ...
    {/* <Card className="bg-dark text-white" >
      <Card.Img  className='gps' 
      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRj9TMxDziyhFCozh04hfsqiETSG6cfZyYbGg&usqp=CAU" 
      alt="Card image" />
      <Card.ImgOverlay>
